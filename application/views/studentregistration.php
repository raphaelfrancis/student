...
<br>
  ...
  <div class="row">
    ...
    <div class="col-sm-4" >
      <input type ="text" name ="studentage" class = "form-control" id ="studentage" >
    </div>
    <div class="col-sm-4" >
  ...
  <div class="row">
    ...
    <div class="col-sm-2">
    <input class="form-check-input" name="studentgender" type="radio" id="studentgender">male
    </div>
    <div class="col-sm-2">
     <input class="form-check-input" name="studentgender" type="radio" id="studentgender">female
    </div>
    <div class="col-sm-3" >
  ...
  <div class="row">
    ...
    <div class="col-sm-4" >
  <textarea rows = "4" cols = "15" name = "studentaddress" class="form-control" id = "studentaddress"></textarea><br>
  </div>
  <div class="col-sm-4" >
...
<br>
  ...
  <div class="row">
    ...
    <div class="col-sm-4" >
      <input type ="text" name ="studentrollno"  class="form-control" id = "studentrollno">
    </div>
    <div class="col-sm-4" >
